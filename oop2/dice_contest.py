...
def main():
    ...
    while game_number < number_of_games:
        ...
        if sum(swapper.get_dice()) == sum(extra_dice.get_dice()):
            #print("Draw!")
            pass
        elif sum(swapper.get_dice()) > sum(extra_dice.get_dice()):
    ...
    print(f"Extra dice won: {extra_dice_score}")

    # determine the winner
    if swapper_score == extra_dice_score:
        print("Game was drawn")
    elif swapper_score > extra_dice_score:
        print("Swapper won most games")
    else:
        print("Extra dice won most games")
